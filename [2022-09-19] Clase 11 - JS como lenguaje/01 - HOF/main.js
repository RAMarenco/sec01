...
const main = () => {
    ...
    console.log(`Suma de numeros: ${result}`);*/
    ...
    console.log(`Multiplicación de elementos: ${calculate(testNumbers01, timesCallback)}`);
    ...
    console.log(`Multiplicación de elementos: ${flatArray("times")(testNumbers01)}`);
    console.log(`División de elementos: ${flatArray("div")(testNumbers01)}`);
    console.log(`Nada de elementos: ${flatArray("UwU")(testNumbers01)}`);
